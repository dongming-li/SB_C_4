 ...
 * @author Brian Newman
 * The Main Activity for our project. This is started when the app
 * is opened, and handles various data passing as well as fragment 
 * management.
 */
public class MainActivity extends AppCompatActivity
    ...
    /**
	 * An interface for storing the username.
	 */
    ...
    /**
	 * Switches the current fragment, based on what the user clicked
	 * in the navigation drawer. 
	 * @param item the MenuItem containing the fragment ID to switch to.
	 */
...
//        setTitle(item.getTitle());
    ...
    /**
	 * To be called when the permissions request is complete. Passes
	 * the result and information to the LocationHandler for handling.
	 * @param requestCode
	 * @param permissions
	 * @param grantResults
	 */
