...
public class MainActivity extends AppCompatActivity
    ...
    private int userId;         //added by wen
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragmentManager.beginTransaction().add(R.id.flContent, new HomeFragment()).commit();
    ...
    public void onDataPass(Bundle data) {
        if(data != null) {
            ...
            userId = data.getInt("userId");         //added by wen
        }
    }
    ...
    public void selectDrawerItem(MenuItem item) {
        ...
        Class fragmentClass;
        bundle.putString("username", username); // added by wen
        bundle.putInt("userId", userId); ///added by wen
